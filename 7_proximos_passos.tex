...
\begin{itemize}
    \item \textbf{Correção do Processo de Balanceamento:} Reconhece-se que aplicar o balanceamento de classes antes da divisão (atualmente apenas treino/teste) de dados é metodologicamente falho e propenso a gerar resultados enganosos e enviesados, protanto essa será uma correção importante e prioritária.
...
\begin{itemize}
    \item \textbf{Correção Monetária:} Implementação de correção monetária dos valores de indenização para uma data base (e.g., 2025) utilizando índices oficiais como o IPCA, mitigando distorções causadas pela inflação e mudanças de jurisprudência.
