...
Para a correta execução, é necessário ter a versão 3.10 do \textit{Python}, E o gerenciador de dependências \textit{pip}. Após instalado, crie um ambiente virtual e instale as dependências necessárias:
