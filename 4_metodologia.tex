...
Nesta fase exploratória, aplicou-se o balanceamento antes da divisão treino/teste.
Reconhece-se que esta abordagem impõe limitações à generalização dos resultados preliminares (potencial data leakage),
sendo a correção deste fluxo — com a aplicação do balanceamento estritamente sobre o conjunto de treino —
uma das prioridades metodológicas já mapeadas para a próxima etapa da pesquisa (Capítulo \ref{sec:proximos_passos}).
