...
O gráfico de enxame (\textit{bee-swarm plot}) mostrado na Figura \ref{fig:global_bee_swarm} complementa essa análise, mostrando não apenas a importância, mas também a direção do impacto de cada fator.
% [TODO 2: Pesquisar mais como interpretar o gráfico SHAP]
% Nele, é possível visualizar que valores altos de "Intervalo de Atraso" e a presença de "Desamparo" (valores em vermelho) tendem a levar a predição para valores de indenização mais altos.
